...
typedef std::pair<std::vector<double>*, std::vector<double>*> PointerPair;

VectorPair GenerateConvVectors(int dimension, int max_cord_value = 1000, int signs_after_point = 3)
{
    ...
    return VectorPair (a, b);
}


VectorPair GenerateInconvVectors(PointerPair conv_vectors)
{
    ...
    return VectorPair (a_inconv, b_inconv);
}
